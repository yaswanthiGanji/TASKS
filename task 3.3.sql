...
use hmbank;
select t.transaction_id, t.account_id, a.customer_id, c.first_name, c.last_name,  t.transaction_type, t.amount, 
t.transaction_date,c.DOB, c.email, c.phone_number, c.address from transactions t
